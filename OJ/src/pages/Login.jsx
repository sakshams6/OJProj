...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl transition-transform transform hover:scale-105">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-pink-600 focus:ring-2 focus:ring-purple-400/50 transition-all transform hover:scale-105 disabled:opacity-50"
            >
